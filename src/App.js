...
function App() {
  const description = 'This is example message for sharing tournament';
  const url = 'communitygaming.io';
    ...
    <div className="App">
      <header className="App-header">
        <div className="share-icon-collections">
          ...
          <a
            href={`https://pinterest.com/pin/create/button/?url=${url}&media=&description=${encodeURI(description)}`}
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a href={`whatsapp://send?text=${description},${url}`}>
            <svg viewBox="0 0 32 32" className="share-icon" style={{ width: 30 }}>
              <path
